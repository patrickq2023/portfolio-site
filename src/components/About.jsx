    ...
    <div className="about-heading-container">
      ...
      <div className="about-container">
        <div className="paragraph-container">
          ...
          <div>
            <p>
              Hello! My name is Patrick, my friends call me pq, I'm a London based Junior Software Engineer.
            </p>    
            <p>               
            ...
            <hr />
            <p>
              Please take a look at my <Link to="/projects">projects</Link> and if you like what you see please feel free to get in touch.
            </p>                   
          </div>
        </div>
      </div>
      ...
      <div className="about-container">
        <div className="paragraph-container">
          ...
          <p>  
            Outside of work I have plenty of other interests including travelling, enjoying great food, Formula1 and snowboarding. 
            ...
            <hr />
            Feel free to have a look at my personal <a href="https://www.instagram.com/patrickq2010/">Instagram</a> to view a few of my adventures.
          </p>
        </div>
      </div>
      <div className="about-container">         
